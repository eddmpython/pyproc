...
export const channels = [
  {
    name: "GitHub",
    href: "https://github.com/eddmpython/pyproc",
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/eddmpython/",
...
class SnsLinks extends HTMLElement {
  connectedCallback() {
    ...
    for (const channel of channels) {
      ...
      link.className = channel.modifier ? `snsBtn ${channel.modifier}` : "snsBtn";
...
if (!customElements.get("sns-links")) customElements.define("sns-links", SnsLinks);
