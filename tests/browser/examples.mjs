...
const PAGES = ["tests/browser/brandGate.html", "", "examples/basic.html", "examples/durable.html", "examples/agentSandbox.html", "examples/terminal.html", "examples/machine.html", "examples/immortal.html", "examples/serverDev.html", "examples/speedLab.html", "examples/processOs.html"];
