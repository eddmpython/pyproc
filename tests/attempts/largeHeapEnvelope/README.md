...
진행 중. 512MB checkpoint/session/fork/journal 수치는 확보했고 journal 반복 blob IO 병목도 1차 해소했다. 다음 목표는 `.pymachine` v2(`/home` 포함)와 신뢰 체인이다. pack/prune은 장기 OPFS 파일 수 최적화로 남긴다.
