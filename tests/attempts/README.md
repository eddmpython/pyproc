...
| [webMachine/](webMachine/) | 서로 다른 guest engine을 같은 browser computer lifecycle/device/image 계약으로 다룰 수 있는가 | 진행 중 (Phase 1/2 GREEN, Phase 3 Dual-Boot 핵심 GREEN, 공통 장치 배선 대기) |
