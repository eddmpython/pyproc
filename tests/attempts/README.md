...
| [webMachine/](webMachine/) | 서로 다른 guest engine을 같은 browser computer lifecycle/device/image 계약으로 다룰 수 있는가 | 진행 중 (Dual-Boot, durable generation, 실제 guest block-backed file GREEN. packet/display/owner 대기) |
