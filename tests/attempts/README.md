...
pyproc의 실험 졸업 게이트다. **신규 능력·실험은 `src/` 직행 금지.** 반드시 여기서 카테고리를 열고, 브라우저 실측으로 졸업 게이트를 통과한 뒤에만 본진(src)으로 승격한다. 검증 전 src 오염을 막는 가드다.
...
| [Initiative 0](machineEntrance/) | exact package에서 첫 유용한 결과까지 조립 없이 도달할 수 있는가 | 착수 대기 |
| [Initiative 1](perceptionComputer/) | screenshot이나 full tree 대신 목표별 최소 충분 상황 모델을 만들 수 있는가 | Initiative 0 후행 대기 |
