...
진행 중. 결정성/리플레이/성장/이미지+/home/디스크/오프라인 2단/부트 자산 SRI v2/Service Worker 자산 봉인/공유 커널/호스팅 독립 2단/파일 세계/init/체크포인트 나무/forkLive/저널 WAL/IPC/컨테이너/커널 선출/잡 컨트롤/권한 감옥은 실측과 승격을 통과했다. 잔여 심화축은 공개키 배포/권한 UI, 장기 journal pack/prune, 제품 표면 배선 확장이다.
