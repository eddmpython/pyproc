...
Linux x64 uses `pyproc_control-0.0.31-py3-none-manylinux_2_28_x86_64.whl`. On other platforms install
`pyproc_control-0.0.31-py3-none-any.whl` together with `npm install --save-exact pyproc@0.0.31`.
