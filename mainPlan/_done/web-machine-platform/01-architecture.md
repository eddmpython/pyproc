...
| adapter | 첫 근거 | 역할 |
|---|---|---|
| pyproc | `openPersistentMachine`, `Session`, `MachineJournal`, [dualEngineProbe](../../../tests/webMachine/browser/probes/dualEngineProbe.html) GREEN 13/13 x3 | 첫 guest OS, `portable` snapshot, heap + `/home/web` + failover |
| WASI | `bootWasi`, `WasiSession`, [dualEngineProbe](../../../tests/webMachine/browser/probes/dualEngineProbe.html) GREEN 13/13 x3 | 두 번째 엔진, `session` snapshot, lifecycle contract의 엔진 독립성 증명 |
| x86 | 외부 주입형 v86 0.5.424, [linuxGuestProbe](../../../tests/webMachine/browser/probes/linuxGuestProbe.html) GREEN 8/8 x3, [dualBootProbe](../../../tests/webMachine/browser/probes/dualBootProbe.html) GREEN 8/8 x3, [framebufferPointerProbe](../../../tests/webMachine/browser/probes/framebufferPointerProbe.html) GREEN 18/18 x3, [clockEntropyProbe](../../../tests/webMachine/browser/probes/clockEntropyProbe.html) GREEN 19/19 x3 | Buildroot Linux 6.8.12 i686와 graphical KolibriOS `portable` state, pyproc + Linux Dual-Boot 및 pixel/pointer/clock/entropy device 증명 |

[deviceBackedDualBootProbe](../../../tests/webMachine/browser/probes/deviceBackedDualBootProbe.html)는 pyproc heap에서
...
[packetNetworkProbe](../../../tests/webMachine/browser/probes/packetNetworkProbe.html)는 browser 계층의 bounded
...
[displayInputProbe](../../../tests/webMachine/browser/probes/displayInputProbe.html)는 `text-cells` display와
...
[framebufferPointerProbe](../../../tests/webMachine/browser/probes/framebufferPointerProbe.html)는 `rgba-frame`
...
[clockEntropyProbe](../../../tests/webMachine/browser/probes/clockEntropyProbe.html)는 `wall-monotonic` clock과
...
[ownerSuccessorProbe](../../../tests/webMachine/browser/probes/ownerSuccessorProbe.html)는 browser coordination을
