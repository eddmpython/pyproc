...
상태: **Phase 1-9 구현 완성 (2026-07-14).** attempts 캠페인 [browserControl](../../tests/attempts/browserControl/README.md)이
링 1(MV3 확장) 게이트 1-21을 브라우저 실측으로 통과했다(**55/55 GREEN**): Phase 1(부팅/격리/CDP왕복/신뢰입력/
...
+ Phase 9(다운로드 관측 = enableDownloads/waitForDownload로 무엇이 다운로드되는지 파일명·URL 회수).
