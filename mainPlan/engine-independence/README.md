...
상태: **착수·대량 실행됨 (2026-07-13 갱신).** 처음엔 "착수 결정 대기"였으나 P1 seam + D2 관문(non-Pyodide 완전 실증) + WASI src 승격(bootWasi/WasiSession) + 죽은 WLR 3.12 -> 살아있는 brettcannon 3.14.6 이전 + P3 engine-watch 자동성장까지 실행했다. 상세 실행 기록은 [web-python-runtime 원장](../web-python-runtime/03-progress-ledger.md)(2026-07-13 항목들)이 정본. **남은 열린 rung: P0(자가 호스팅, 유일 실시간 CDN 리스크) + P2(스냅샷 사전 제조).** 아래 사다리에 완료/열림 표시.
