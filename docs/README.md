...
| [reference/](reference/) | [api.md](reference/api.md) | 영문 API 레퍼런스: 루트 export 전수의 시그니처/오류 코드/경계(기계 게이트로 전수 앵커 강제) |
| | [comparison.md](reference/comparison.md) | 영문 외부 비교: WebVM/JupyterLite/marimo 대비 시나리오 전수, artifact 링크가 셀 값, N/A는 사유와 함께 |
