...
| 지속 문서 | [docs/](../) | 제품 방향, 소비 계약, 레퍼런스, 반복되는 운영 정책 | "다음 릴리즈와 외부 소비자가 계속 읽어야 하는가?" |
...
- **지속되는 결정만 docs로 승격한다.** 제품 방향은 `docs/product/vision.md`, 실제와 계약의 열린 차이는 `docs/operations/contractReality.md`, 소비 표면은 `docs/consuming/`, 함수 계약은 `docs/reference/`가 소유한다. 일회성 작업 계획을 새 영구 트리로 만들지 않는다.
