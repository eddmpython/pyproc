...
| S1 | numpy sharded matmul | `examples/speedLab.html`, `matmulSurfaceProbe.html` | single median, shard median, speedup, shard p95 | `maxErr < 1e-9`, `medianSpeedup >= 2.0`, `shard p95 < single median` |
