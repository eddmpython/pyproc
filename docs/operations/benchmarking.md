...
| S5 immortal multi-tab machine | [측정됨](../../mainPlan/browser-os-north-star/benchmarks/s5-pyproc-2026-07-15.json) | N/A | N/A | N/A | 설치 패키지 leader fencing, heap + `/home/web` journal recovery, cold reopen의 결합 계약. 외부 후보에 같은 공개 계약이 없음 |
