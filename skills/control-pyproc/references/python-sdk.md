...
On Linux x64 install `pyproc_control-0.0.27-py3-none-manylinux_2_28_x86_64.whl` from the same release. The
...
```sh
npm install --save-exact pyproc@0.0.27
python -m pip install \
  "https://github.com/eddmpython/pyproc/releases/download/v0.0.27/pyproc_control-0.0.27-py3-none-any.whl"
```
