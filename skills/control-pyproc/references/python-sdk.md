...
python -m pip install \
  "https://github.com/eddmpython/pyproc/releases/download/v0.0.31/pyproc_control-0.0.31-py3-none-win_amd64.whl"
```

On Linux x64 install `pyproc_control-0.0.31-py3-none-manylinux_2_28_x86_64.whl` from the same release. The
...
```sh
npm install --save-exact pyproc@0.0.31
python -m pip install \
  "https://github.com/eddmpython/pyproc/releases/download/v0.0.31/pyproc_control-0.0.31-py3-none-any.whl"
```
