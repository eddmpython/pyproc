...
```sh
npm install pyproc@0.0.25 --save-exact
```
...
all three options to keep Execution Memory closed. See [Execution Memory](./execution-memory.md).
...
coordinator closed. See [Rehearse-Commit Transactions](../../commit-pyproc-effects/references/rehearse-commit.md).
